...
import OperasiStandar.Kalkulator;
import OperasiStandar.Enkapsulasi;
import OperasiStandar.KalkulatorMatriks;
import OperasiStandar.KalkulatorStandar;
import Trigonometri.konversiSudut;
import Trigonometri.kurangTrigonometri;

import Trigonometri.penjumlahanTrigonometri;
import Trigonometri.trigonometriInterface;
import java.util.Scanner;

public class Tampilan {

    public String Nama,email, Nim;
     public int pass;
    ...
    public void Layar() {
        ...
        trigonometriInterface trigKur=new kurangTrigonometri();
        login<String> namaString = new login<>();
        login<String> emailString = new login<>();
        login<Integer> passInt= new login<>();
        ...
        Nama=scan.nextLine();
        namaString.setLogin(Nama);
        System.out.print("Masukan Email Anda :" );
        Nama=scan.nextLine();
        emailString.setLogin(email);
        System.out.print("Masukan Password Anda :" );
        pass=scan.nextInt();
        passInt.setLogin(pass);
        
        
        do {
            System.out.println("\n" );
            System.out.println(namaString.getLogin());
            System.out.println("===========================================");
